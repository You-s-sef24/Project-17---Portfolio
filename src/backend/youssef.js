export const youssef = {
    ...
    skills: {
        frontend: [{ name: "HTML", exp: 95 }, { name: "CSS", exp: 75 }, { name: "JavaScript", exp: 85 }, { name: "React", exp: 90 }, { name: "Bootstrap", exp: 90 }],
        tools: [{ name: "Git", exp: 90 }, { name: "GitHub", exp: 90 }, { name: "Postman", exp: 90 }],
    },
    languages: ["Arabic (Native)", "English (Professional)"],
    linkedin: "https://www.linkedin.com/in/you-s-sef24",
    instagram: "https://www.instagram.com/youssefmahmoud.2004/",
    facebook: "https://www.facebook.com/profile.php?id=100007855056382&ref=_ig_profile_ac",
    github: "https://github.com/You-s-sef24",
    education: {
    ...
    contactForm: {
        emailReceiver: "ym849447@gmail.com"
    }
};